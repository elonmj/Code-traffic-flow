...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            ...
            \includegraphics[width=\textwidth]{results/plot_seg_0_density_moto.png}
        \end{column}
        \begin{column}{.5\textwidth}
            \textbf{Vitesse des Voitures ($v_c$)}
            \includegraphics[width=\textwidth]{results/plot_seg_0_velocity_car.png}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            \textbf{Densité des Motos ($\rho_m$)}
            \includegraphics[width=\textwidth]{results/plot_seg_1_density_moto.png}
        \end{column}
        \begin{column}{.5\textwidth}
            \textbf{Vitesse des Voitures ($v_c$)}
            \includegraphics[width=\textwidth]{results/plot_seg_1_velocity_car.png}
        \end{column}
    \end{columns}

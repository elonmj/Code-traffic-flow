...
class Intersection:
    ...
    def __init__(self, node_id: str, incoming_segments: List[str], outgoing_segments: List[str],
        ...
        Args:
            ...
            incoming_segments: Liste des segments entrants
            outgoing_segments: Liste des segments sortants
    ...
    def get_config(self) -> Dict[str, Any]:
        """
        Returns the configuration of the intersection.
        """
        return {
            "node_id": self.node_id,
            "incoming_segments": self.incoming_segments,
            "outgoing_segments": self.outgoing_segments,
            "traffic_lights": self.traffic_lights.get_config() if self.traffic_lights else None,
        }

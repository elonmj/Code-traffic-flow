...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/intro/lagos_street_market.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/intro/lagos_traffic_motos.jpg}
...
Pour aborder ce problème, nous formulons les questions de recherche suivantes :
\begin{enumerate}

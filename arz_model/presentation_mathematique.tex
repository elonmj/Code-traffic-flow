...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            \textbf{Densité des Motos ($\rho_m$)}
            \includegraphics[width=\textwidth]{Network Simulation Results - seg_0 (Motorcycle Density).png}
        \end{column}
        \begin{column}{.5\textwidth}
            \textbf{Vitesse des Voitures ($v_c$)}
            \includegraphics[width=\textwidth]{Network Simulation Results - seg_0 (Car Velocity).png}
        \end{column}
    \end{columns}
    ...
    \begin{itemize}
        ...
        \item \textit{À gauche :} La densité augmente (couleurs vertes/jaunes).
        \item \textit{À droite :} La vitesse des voitures chute drastiquement (couleur violet foncé).
    \end{itemize}
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            \textbf{Densité des Motos ($\rho_m$)}
            \includegraphics[width=\textwidth]{Network Simulation Results - seg_1 (Motorcycle Density).png}
        \end{column}
        \begin{column}{.5\textwidth}
            \textbf{Vitesse des Voitures ($v_c$)}
            \includegraphics[width=\textwidth]{Network Simulation Results - seg_1 (Car Velocity).png}
        \end{column}
    \end{columns}
    ...
    \begin{itemize}
        ...
        \item \textit{À gauche :} La densité reste très faible (violet), car les véhicules sont bloqués sur le segment précédent.
        \item \textit{À droite :} La vitesse des voitures est élevée (vert/jaune), ce qui est cohérent avec un trafic fluide.
    \end{itemize}
